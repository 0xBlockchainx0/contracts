...
// File: contracts/lib/ERC721PresetPauserAutoId.sol
 ...
 *  - a minter role that allows for token minting (creation)// no minter role update
 ...
 */
contract ERC721PresetPauserAutoId is Context, AccessControl, ERC721Burnable, ERC721Pausable {
    ...
    function pause() public virtual {
        require(hasRole(PAUSER_ROLE, _msgSender()), "ERC721PresetPauserAutoId: must have pauser role to pause");
        _pause();
    }
    ...
    function unpause() public virtual {
        require(hasRole(PAUSER_ROLE, _msgSender()), "ERC721PresetPauserAutoId: must have pauser role to unpause");
        _unpause();
    }
...
// File: contracts/HuddlnMediaAsset.sol
